...
### 2.2 安装 Llamaindex
点击vscode，新建终端，在终端中安装 Llamaindex和相关的包
```bash
conda activate llamaindex
...
```
结果为：
![1723368400317](images/1723368400317.png)
...
```
结果为：
![1723368828072](images/1723368828072.png)
...
![1723369999129](images/1723369999129.png)

即可进入以下网页，然后就可以开始尝试问问题了。

![1723369966424](images/1723369966424.png)

询问结果为：

![1723369942603](images/1723369942603.png)
