...
在安装 XTuner 之前，我们需要先创建一个虚拟环境。使用 `Anaconda` 创建一个名为 `xtuner` 的虚拟环境，可以直接执行命令。
...
![1723445525388](images/1723445525388.png)
...
![1723445825550](images/1723445825550.png)
...
<img src="images/1723446869657.png" alt="1723446869657" style="zoom:150%;" />

最后，我们就可以在本地通过浏览器访问：http://localhost:8501 来进行对话了。

![1723447037092](images/1723447037092.png)
...
|       |   |-- 20240812_153734.log
|       |   `-- vis_data
|       |       |-- 20240812_153734.json
|       |       |-- config.py
|       |       |-- eval_outputs_iter_287.txt
|       |       `-- scalars.json
|       |-- internlm2_chat_1_8b_qlora_alpaca_e3_copy.py
|       |-- iter_288.pth
|       `-- last_checkpoint
...
最后，通过浏览器访问：http://localhost:8501 来进行对话了。

![1723450970644](images/1723450970644.png)
